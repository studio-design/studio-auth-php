...
class PendingAuthenticationLookupRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $pendingAuthenticationToken `/oauth/authorize` が `organization_selection_required` レスポンスとともに発行した pending_authentication_token (opaque、64 文字 hex)。短 TTL・単回使用。  credential 相当のため、必ず request body で送信すること (URL に置くと access log / Referer / browser history / CDN cache / OpenTelemetry trace に漏洩する)。
     *
     * @return $this
     */
