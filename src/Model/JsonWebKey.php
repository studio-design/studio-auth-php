...
class JsonWebKey implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'kty' => '\Studio\Auth\Model\JwkKeyType',
        'use' => '\Studio\Auth\Model\JwkKeyUse',
        'kid' => 'string',
        'alg' => '\Studio\Auth\Model\JwkSigningAlg'
    ];
    ...
    */
     ...
     * Gets kty
     *
     * @return \Studio\Auth\Model\JwkKeyType
     */
    public function getKty(): \Studio\Auth\Model\JwkKeyType
    {
     ...
     * Sets kty
     *
     * @param \Studio\Auth\Model\JwkKeyType $kty kty
     *
     * @return $this
     */
    public function setKty(\Studio\Auth\Model\JwkKeyType $kty): static
    {
        if (is_null($kty)) {
     ...
     * Gets use
     *
     * @return \Studio\Auth\Model\JwkKeyUse
     */
    public function getUse(): \Studio\Auth\Model\JwkKeyUse
    {
     ...
     * Sets use
     *
     * @param \Studio\Auth\Model\JwkKeyUse $use use
     *
     * @return $this
     */
    public function setUse(\Studio\Auth\Model\JwkKeyUse $use): static
    {
        if (is_null($use)) {
     ...
     * Gets alg
     *
     * @return \Studio\Auth\Model\JwkSigningAlg
     */
    public function getAlg(): \Studio\Auth\Model\JwkSigningAlg
    {
     ...
     * Sets alg
     *
     * @param \Studio\Auth\Model\JwkSigningAlg $alg alg
     *
     * @return $this
     */
    public function setAlg(\Studio\Auth\Model\JwkSigningAlg $alg): static
    {
        if (is_null($alg)) {
