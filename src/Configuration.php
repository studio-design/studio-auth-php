...
class Configuration
{
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/0.6.3-rc.55/PHP';
    ...
    public static function toDebugReport(): string
    {
        ...
        $report .= '    The version of the OpenAPI document: 0.6.2' . PHP_EOL;
        $report .= '    SDK Package Version: 0.6.3-rc.55' . PHP_EOL;
