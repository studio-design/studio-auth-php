...
class Configuration
{
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/0.2.25-next.8c703ba/PHP';
    ...
    public static function toDebugReport(): string
    {
        ...
        $report .= '    The version of the OpenAPI document: 0.2.24' . PHP_EOL;
        $report .= '    SDK Package Version: 0.2.25-next.8c703ba' . PHP_EOL;
